...
const PORT = process.env.SERVER_PORT || process.env.PORT || 7745;        // http服务订阅端口
const UUID = process.env.UUID || 'a2b9c255-701f-4d22-b6a3-5477c0ab58b0'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'zha.wuge.nyc.mn:36102';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || 'poV6P9ywomV0G4of62JGBFitqvV3facM';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'optiklink.wuge.nyc.mn';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNzU0MTM1NWEwYThlODY5Yzc3MWI2ZTEzODViODgyMmMiLCJ0IjoiMmYyMjRkYTItYzg5My00MGYxLWEzNDgtMDQ2ZWQ0ZTExYjNiIiwicyI6Ik5EUmhOMlExTVRrdE1qazBNQzAwWVRJMkxUZ3dOVEF0TkRsa09ERXhaVGN4TkdGayJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://fscarmen.cloudflare.now.cc
